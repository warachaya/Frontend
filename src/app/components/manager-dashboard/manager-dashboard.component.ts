...
import { WeekandMonth_ } from 'src/app/Models/Fillingweekandmonth';
    ...
    this.networkService.getTransac2().subscribe((data) => {
                                                          ...
                                                          this.networkService.getMSUGas().subscribe((data) => {
                                                            ...
                                                            this.networkService.getMSUOWB().subscribe((data) => {
                                                              ...
                                                              if ((this.Month = 6)) {
                                                                ...
                                                                this.barChartLabels = ['SaleOffice','Inbound WB','Diesel Bay','Gasohol Bay','Outbound WB',];
      ...
      for (let i = 0; i <= 3; i++) {
        if (this.CompDate == this.Date[i].viewValue) {
          ...
          this.TruckIn = data.result[i].C_Truck_In;
          this.TruckOut = data.result[i ].Truck_Out;
          this.FillDiesel = data.result[i ].Amount_of_Fuel_diesel_;
          this.FillGas = data.result[i ].Amount_of_Fuel_gasohol95_;
          this.reFillGas = Number(this.FillGas).toFixed(2);
